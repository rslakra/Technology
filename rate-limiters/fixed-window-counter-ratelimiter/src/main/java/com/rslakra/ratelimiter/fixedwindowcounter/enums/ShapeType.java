package com.rslakra.ratelimiter.fixedwindowcounter.enums;
...
public enum ShapeType {
    ...
    // 3D Shapes
    /**
     * Sphere is a three-dimensional geometric shape that is perfectly round.
     */
    SPHERE,
    
    /**
     * Cube is a three-dimensional shape with six equal square faces.
     */
    CUBE,
    
    /**
     * Cylinder is a three-dimensional shape with two parallel circular bases.
     */
    CYLINDER,
    
    /**
     * Cone is a three-dimensional shape with a circular base tapering to a point.
     */
    CONE,
    
    /**
     * Cuboid (Rectangular Prism) is a three-dimensional shape with six rectangular faces.
     */
    CUBOID,
    ;
}
