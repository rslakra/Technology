...
import com.rslakra.ratelimiter.leakybucket.controller.ShapeController;
...
class ShapeControllerRateLimiterTest {
    ...
    void setUp() {
        ...
        com.rslakra.ratelimiter.leakybucket.payload.response.ShapeResponse mockResponse = 
            new com.rslakra.ratelimiter.leakybucket.payload.response.ShapeResponse();
