...
import com.rslakra.ratelimiter.slidingwindowcounter.controller.ShapeController;
...
import com.rslakra.ratelimiter.slidingwindowcounter.ratelimiter.SlidingWindowCounterRateLimiter;
import com.rslakra.ratelimiter.slidingwindowcounter.service.ShapeService;
...
class ShapeControllerRateLimiterTest {
    ...
    void setUp() {
        ...
        com.rslakra.ratelimiter.slidingwindowcounter.payload.response.ShapeResponse mockResponse = 
            new com.rslakra.ratelimiter.slidingwindowcounter.payload.response.ShapeResponse();
