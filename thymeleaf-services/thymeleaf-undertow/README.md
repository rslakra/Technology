# Spring Boot Thymeleaf Sidebar Application (Undertow)

A modern Spring Boot 3.5.7 application with Thymeleaf template engine featuring a responsive sidebar navigation, breadcrumb navigation, and CRUD operations. This application uses **Undertow** as the embedded web server.
...
- **Spring Boot**: 3.5.7
- **Java**: 21
- **Embedded Server**: Undertow (via `spring-boot-starter-undertow`)
...
The application will start on `http://localhost:8080` using Undertow as the embedded web server.
