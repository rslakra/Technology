package com.rslakra.thymeleafsidebarsversion.tutorial.controller;

import com.rslakra.thymeleafsidebarsversion.tutorial.service.TutorialService;
...
@Controller
@RequestMapping("/{version}/tutorials")
public class TutorialController {
    ...
    public String getAll(@PathVariable("version") String version, Model model, @Param("keyword") String keyword) {
        ...
        return version + "/tutorial/listTutorials";
    }
     ...
     */
    @GetMapping("/add")
    public String addTutorial(@PathVariable("version") String version, Model model) {
        Tutorial tutorial = new Tutorial();
        tutorial.setPublished(true);
        model.addAttribute("tutorial", tutorial);
        model.addAttribute("pageTitle", "Create Tutorial");

        return version + "/tutorial/editTutorial";
    }
     ...
     */
    @PostMapping("/save")
    public String saveTutorial(@PathVariable("version") String version, Tutorial tutorial, RedirectAttributes redirectAttributes) {
        try {
        ...
        return "redirect:/" + version + "/tutorials";
    }
    ...
    public String updatePublishedStatus(@PathVariable("version") String version, @PathVariable("id") Long id,
