...
(function () {
    ...
    class Sidebar {
        ...
        applyStateEarly() {
            ...
            if (wrapper) {
                // Only apply active class if sidebar should be collapsed
        ...
        setupProfileDropdown() {
            ...
            $(".top_navbar .right_menu .fas, .top_navbar .menu .right_menu ul li .fas").click((e) => {
                ...
                // Also support legacy profile-menu if it exists
            ...
            $(document).click((e) => {
                if (!$(e.target).closest('.right_menu').length) {
                    $(".profile-dropdown, .profile-menu").removeClass("active");
                }
            });
        }
        ...
        setupActiveMenuItemListeners() {
            ...
            // IMPORTANT: Don't toggle sidebar state - preserve current state
            var self = this;
            $(".sidebar ul li a, .sidebar .sidebar-footer-menu li a").click(function (e) {
                // Don't prevent default - allow navigation
                // Just update active state
                $(".sidebar ul li a, .sidebar .sidebar-footer-menu li a").removeClass("active");
                $(this).addClass("active");

                // Preserve sidebar state - don't toggle it
                // The sidebar state should only change when hamburger is clicked
            });
        }
