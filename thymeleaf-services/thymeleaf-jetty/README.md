# Spring Boot Thymeleaf Sidebar Application (Jetty)

A modern Spring Boot 3.5.7 application with Thymeleaf template engine featuring a responsive sidebar navigation, breadcrumb navigation, and CRUD operations. This application uses **Jetty** as the embedded web server.
...
- **Spring Boot**: 3.5.7
- **Java**: 21
- **Embedded Server**: Jetty (via `spring-boot-starter-jetty`)
...
The application will start on `http://localhost:8080` using Jetty as the embedded web server.
